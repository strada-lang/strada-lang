...
# Test: parser precedence — =~ binds tighter than == (RHS of equality
# must descend into parse_regex_match, not parse_relational).
test_output_contains "$EXAMPLES_DIR/test_eq_regex_prec.strada" "test_eq_regex_prec" "All tests passed" "Equality / regex-match precedence"

# Test: semantic pass analyzes switch statements (scrutinee, case exprs,
