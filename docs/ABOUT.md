...
- Fast execution speed (3.4x faster than Python, 3.5x faster than Perl on array/hash benchmarks)
- Zero-allocation integer arithmetic via tagged pointers
- Small binary size
- Easy deployment
...
| Speed | Good | Faster |
| Memory | Managed | Tagged ints + refcounting |
